...
const PRESETS = [
  { name: 'night_a',  hour: 0,   url: 'assets/night.hdr'   },
  { name: 'night_a2', hour: 4,   url: 'assets/night.hdr'   }, // hold until pre-dawn
  { name: 'sunrise',  hour: 7,   url: 'assets/sunrise.hdr' },
  { name: 'day',      hour: 9,   url: 'assets/day.hdr'     }, // reach full day
  { name: 'day_b',    hour: 16,  url: 'assets/day.hdr'     }, // hold full day
  { name: 'sunset',   hour: 19,  url: 'assets/sunset.hdr'  },
  { name: 'night_b',  hour: 21,  url: 'assets/night.hdr'   }, // hold night through end
  { name: 'night_b2', hour: 24,  url: 'assets/night.hdr'   },
];
