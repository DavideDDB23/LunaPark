...
- [ ] Fix legs in `passengers.js` (use `applyChairSeatedLegs` and apply some rotation)
...
- [ ] Fix legs in `passengers.js` (`applyChairSeatedLegs`)
- [ ] Fix position of some passenger models (some are clipped into the chair)
